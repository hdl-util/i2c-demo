...
project_open -revision i2c-demo i2c-demo
...
# SAMD21 I2C
set_location_assignment PIN_C15 -to SDA
set_location_assignment PIN_B16 -to SCL
...
set_location_assignment PIN_L1  -to MIPI_D[0](n)
set_location_assignment PIN_J1  -to MIPI_D[1](n)
set_location_assignment PIN_M2  -to MIPI_CLK
set_location_assignment PIN_M1  -to MIPI_CLK(n)
